...
// Normal (unselected windows)
static char normfgcolor[]                = "#f5f5f5"; // light foreground
static char normbgcolor[]                = "#1e1e1e"; // dark background
static char normbordercolor[]            = "#333333"; // normal border
static char normfloatcolor[]             = "#d77a00"; // muted orange accent for floating windows

// Selected (active window)
static char selfgcolor[]                 = "#eeeeee"; // slightly brighter fg
static char selbgcolor[]                 = "#d77a00"; // muted orange background for selected
static char selbordercolor[]             = "#d77a00"; // muted orange border
static char selfloatcolor[]              = "#d77a00"; // floating accent

// Title bar normal
static char titlenormfgcolor[]           = "#f5f5f5";
static char titlenormbgcolor[]           = "#1e1e1e";
static char titlenormbordercolor[]       = "#333333";
static char titlenormfloatcolor[]        = "#d77a00";

// Title bar selected
static char titleselfgcolor[]            = "#eeeeee";
static char titleselbgcolor[]            = "#d77a00";
static char titleselbordercolor[]        = "#d77a00";
static char titleselfloatcolor[]         = "#d77a00";

// Tags normal
static char tagsnormfgcolor[]            = "#f5f5f5";
static char tagsnormbgcolor[]            = "#1e1e1e";
static char tagsnormbordercolor[]        = "#333333";
static char tagsnormfloatcolor[]         = "#d77a00";

// Tags selected
static char tagsselfgcolor[]             = "#eeeeee";
static char tagsselbgcolor[]             = "#d77a00";
static char tagsselbordercolor[]         = "#d77a00";
static char tagsselfloatcolor[]          = "#d77a00";

// Hidden windows
static char hidnormfgcolor[]             = "#d77a00"; // muted orange hint for hidden
static char hidselfgcolor[]              = "#d77a00"; // muted orange hint when selected
static char hidnormbgcolor[]             = "#1e1e1e";
static char hidselbgcolor[]              = "#1e1e1e";

// Urgent
static char urgfgcolor[]                 = "#f5f5f5";
static char urgbgcolor[]                 = "#1e1e1e";
static char urgbordercolor[]             = "#ff3f00"; // keep red for urgent windows
static char urgfloatcolor[]              = "#d77a00"; // accent
...
static const Key keys[] = {
	...
	{ MODKEY|ControlMask,                       XK_space,      spawn,          SHCMD("~/.dwm/toggle_layout.sh") },
	#if RIODRAW_PATCH
